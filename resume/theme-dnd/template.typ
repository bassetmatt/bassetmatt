#import "/lib/trads.typ": blocks, titles, tr
#import "/theme-dnd/style.typ": apply_left-block_style, apply_right-col_style, colors, left-block-style
...
#let resume = {
  {
    ...
    box()[
      ...
      #text(
        ...
        stroke: .2pt + colors.title-stroke,
        // Spaces the chars more
        tracking: .6pt,
      )[
        #titles.job
      ]
